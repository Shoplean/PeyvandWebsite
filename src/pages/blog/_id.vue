        ...
        <div class="-mx-4 flex flex-wrap justify-center">
          <div class="w-full px-4">
            <div
              ...
              data-wow-delay=".1s">
              <img src="/images/blog/blog-details-01.jpg" alt="image"
                ...
                <div class="flex flex-wrap items-center p-4 pb-4 sm:p-8">
                  <div class="mb-4 mr-5 flex items-center md:mr-10">
                    <div class="mr-4 h-10 w-10 overflow-hidden rounded-full">
                      <img src="/images/blog/author-01.png" alt="image" class="w-full" />
                    </div>
                ...
                <div>
                  ...
                  <div class="-mx-4 mb-8 flex flex-wrap">
                    ...
                    <div class="w-full px-4 md:w-1/2 lg:w-full">
                      <div class="wow fadeInUp mb-5 flex w-full items-center border-b border-[#F2F3F8] pb-5"
                        data-wow-delay=".1s
                        ">
                        <div class="mr-5 h-20 w-full max-w-[80px] overflow-hidden rounded-full">
                          <img src="/images/blog/article-author-01.png" alt="image" class="w-full" />
                        </div>
                        <div class="w-full">
                          <h4>
                            <a href="javascript:void(0)"
                    ...
                    <div class="w-full px-4 md:w-1/2 lg:w-full">
                      <div class="wow fadeInUp mb-5 flex w-full items-center border-b border-[#F2F3F8] pb-5"
                        ...
                        ">
                        <div class="mr-5 h-20 w-full max-w-[80px] overflow-hidden rounded-full">
                          <img src="/images/blog/article-author-02.png" alt="image" class="w-full" />
                        </div>
                        <div class="w-full">
                          <h4>
                            <a href="javascript:void(0)"
                    ...
                    <div class="w-full px-4 md:w-1/2 lg:w-full">
                      <div class="wow fadeInUp mb-5 flex w-full items-center border-b border-[#F2F3F8] pb-5"
                        ...
                        ">
                        <div class="mr-5 h-20 w-full max-w-[80px] overflow-hidden rounded-full">
                          <img src="/images/blog/article-author-03.png" alt="image" class="w-full" />
                        </div>
                        <div class="w-full">
                          <h4>
                            <a href="javascript:void(0)"
                    ...
                    <div class="w-full px-4 md:w-1/2 lg:w-full">
                      <div
                        ...
                        ">
                        <div class="mr-5 h-20 w-full max-w-[80px] overflow-hidden rounded-full">
                          <img src="/images/blog/article-author-04.png" alt="image" class="w-full" />
                        </div>
                        <div class="w-full">
                          <h4>
                            <a href="javascript:void(0)"
                  ...
                  <div class="wow fadeInUp mb-12 overflow-hidden rounded" data-wow-delay=".1s">
                    <img src="/images/blog/bannder-ad.png" alt="image" class="w-full" />
                  </div>
                </div>
              </div>
            </div>
